...
var ColorService = __webpack_require__(7);
...
var ColorService = function () {
  function ColorService() {
    ...
    this.hexCodes = _colors2.default;
    this.postCollection = [];
  }
  ...
  _createClass(ColorService, [{
    ...
    value: function getTopColor() {
      ...
      fetch(this.baseUrl + '/api/v1/top_color').then(function (response) {
        return response.json();
      }).then(function (response) {
        return _this.appendTopColor(response);
      });
    }
  }, {
    key: 'postColors',
    ...
    key: 'postConfig',
    value: function postConfig(object) {
      return {
        method: 'POST',
    ...
    key: 'iterateOverCollection',
    value: function iterateOverCollection(array) {
      for (var i = 0; i < array.length; i++) {
